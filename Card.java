...
public class Card {
	...
	/**
	 * Displays a card according to its suit and value. Used to assist {@link #toString()}.
	 * @param c The card to display.
	 * @return The card value and suit where 1, 11, 12, 13, are adjusted for A, J, Q, and K accordingly.
	 */
